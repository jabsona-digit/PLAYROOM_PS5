...
const MODULE_ROLES: Record<ModuleKey, OrgRole[]> = {
  ...
  guide:        ['owner', 'admin', 'manager', 'accountant', 'cashier', 'operator'],
  billing:      ['owner'],
...
const MODULE_ORDER: ModuleKey[] = [
  'dashboard', 'analytics', 'accounting', 'cashier', 'pos', 'reservations', 'online_bookings', 'tournaments', 'history',
  'inventory', 'customers', 'pricing', 'employees', 'settings', 'billing', 'guide',
]
